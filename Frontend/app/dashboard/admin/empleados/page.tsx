...
function EmployeeForm({ mode, empleado, onCancel, onSaved }: EmployeeFormProps) {
        ...
        <div className="grid gap-4 md:grid-cols-3">
          ...
          <label className="space-y-1.5 text-sm font-medium text-gray-700">
            ...
            <select
              ...
              className="h-9 w-full rounded-lg border border-gray-300 bg-white px-2.5 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
            >
              {ROLES.map((role) => (
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-6">
        ...
        <AnimatePresence mode="wait">
          ...
          {panelMode === "edit" && selected && (
            <EmployeeForm key={`edit-${selected.id_empleado}`} mode="edit" empleado={selected} onCancel={closePanel} onSaved={reload} />
          )}
          {panelMode === "password" && selected && (
            <PasswordPanel key={`password-${selected.id_empleado}`} empleado={selected} onCancel={closePanel} onSaved={closePanel} />
          )}
        </AnimatePresence>
                  ...
                  >
                    ...
                    <div className="flex justify-end gap-1.5">
                      ...
                      <Button
                        ...
                        title={isSelf && !inactive ? "No puedes desactivar tu propia cuenta" : undefined}
                      >
